...
// Baseline test
results.push(benchmark("Default options", () => filesize(TEST_SIZE)));

// Test individual options
results.push(benchmark("bits=true", () => filesize(TEST_SIZE, { bits: true })));

results.push(benchmark("pad=true", () => filesize(TEST_SIZE, { pad: true })));

results.push(benchmark("base=2", () => filesize(TEST_SIZE, { base: 2 })));

results.push(benchmark("round=4", () => filesize(TEST_SIZE, { round: 4 })));

results.push(benchmark("locale=true", () => filesize(TEST_SIZE, { locale: true })));

results.push(benchmark('locale="en-US"', () => filesize(TEST_SIZE, { locale: "en-US" })));

results.push(benchmark('separator=","', () => filesize(TEST_SIZE, { separator: "," })));

results.push(benchmark('standard="iec"', () => filesize(TEST_SIZE, { standard: "iec" })));

results.push(benchmark('standard="jedec"', () => filesize(TEST_SIZE, { standard: "jedec" })));

results.push(benchmark('output="array"', () => filesize(TEST_SIZE, { output: "array" })));

results.push(benchmark('output="object"', () => filesize(TEST_SIZE, { output: "object" })));

results.push(benchmark("fullform=true", () => filesize(TEST_SIZE, { fullform: true })));

...
// Test data sets
const testSizes = [0, 512, 1024, 1048576, 1073741824, 1099511627776, Number.MAX_SAFE_INTEGER];
...
results.push(benchmark("filesize w/ bits=true", () => filesize(1048576, { bits: true })));

results.push(benchmark("filesize w/ standard=IEC", () => filesize(1048576, { standard: "iec" })));

results.push(benchmark("filesize w/ round=4", () => filesize(1048576, { round: 4 })));

results.push(benchmark("filesize w/ fullform=true", () => filesize(1048576, { fullform: true })));

results.push(benchmark("filesize w/ output=object", () => filesize(1048576, { output: "object" })));

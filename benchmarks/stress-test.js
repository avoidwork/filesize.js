  ...
  for (let i = 0; i < count; i++) {
    ...
    switch (type) {
      case 0:
        ...
        break;
      case 1:
        values.push(Math.random() * 1024);
        break;
      case 2:
        values.push(Math.random() * 1048576);
        break;
      case 3:
        values.push(Math.random() * 1073741824);
        break;
      case 4:
        values.push(Math.random() * Number.MAX_SAFE_INTEGER);
        break;
      case 5:
        values.push(-Math.random() * 1048576);
        break; // Negative values
    }
  }
  return values;
}
...
results.push(
  benchmark("Very large numbers", () => filesize(Math.random() * Number.MAX_SAFE_INTEGER)),
);

// Test very small numbers
results.push(benchmark("Very small numbers", () => filesize(Math.random() * 0.001)));

// Test negative numbers
results.push(benchmark("Negative numbers", () => filesize(-Math.random() * 1048576)));
...
for (let i = 0; i < 10; i++) {
  const result = benchmark(`Run ${i + 1}`, () => filesize(1073741824), 1000);
...
const variance = Math.sqrt(
  consistencyResults.reduce((acc, val) => acc + Math.pow(val - avgOps, 2), 0) /
